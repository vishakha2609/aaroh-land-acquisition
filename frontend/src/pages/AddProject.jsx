    ...
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      <div className="card">
        <form onSubmit={handleSubmit}>
          {/* Basic Information */}
          <h4 style={{ marginBottom: '12px', color: 'var(--navy-primary)' }}>1. Basic Project Details</h4>
          <div className="grid-2">
            <div className="form-group">
              <label>Project ID</label>
              <input className="form-control" value={formData.id} disabled />
            </div>
            <div className="form-group">
          ...
          <h4 style={{ marginBottom: '12px', color: 'var(--navy-primary)' }}>2. Scale & Social Impact</h4>
          <div className="grid-2">
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input 
                ...
                onChange={e => setFormData({...formData, affectedFamilies: e.target.value})} 
                placeholder="e.g., 180" 
              />
            </div>
            <div className="form-group">
              ...
              <input 
                ...
                onChange={e => setFormData({...formData, landowners: e.target.value})} 
                placeholder="e.g., 220" 
              />
            </div>
            <div className="form-group">
              <label>Stakeholder Responsiveness</label>
              <select className="form-control" value={formData.stakeholderResponse} onChange={e => setFormData({...formData, stakeholderResponse: e.target.value})}>
          ...
          <h4 style={{ marginBottom: '12px', color: 'var(--navy-primary)' }}>3. Acquisition, Clearance & Dispute Status</h4>
          <div className="grid-2">
            <div className="form-group">
              ...
              <input 
                ...
                onChange={e => setFormData({...formData, compensationCompletion: e.target.value})} 
              />
            </div>
            <div className="form-group">
              ...
              <input 
                ...
                onChange={e => setFormData({...formData, possessionPct: e.target.value})} 
              />
            </div>
            <div className="form-group">
              <label>Active Legal Dispute?</label>
              <select className="form-control" value={formData.legalDispute} onChange={e => setFormData({...formData, legalDispute: e.target.value})}>
            ...
            <div className="form-group">
              ...
              <input 
                ...
                onChange={e => setFormData({...formData, courtCases: e.target.value})} 
              />
            </div>
            <div className="form-group">
              ...
              <input 
                ...
                onChange={e => setFormData({...formData, approvalDelayDays: e.target.value})} 
              />
            </div>
          </div>

          <button className="btn btn-primary" type="submit" style={{ marginTop: '20px', width: '100%', justifyContent: 'center' }}>
